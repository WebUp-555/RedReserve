  ...
  const [messages, setMessages] = useState([
    {
      id: 1,
      type: 'bot',
      text: 'Hello! 👋 I\'m the Redreserve Assistant. I can help you with blood donation information, blood types, donation eligibility, and more. What would you like to know?',
      timestamp: new Date(),
    },
  ]);
